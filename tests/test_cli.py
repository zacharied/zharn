...
def test_context_new_without_prompt_sends_empty_prompt(recorder):
    ...
    assert recorder.calls == [("context.new", {"model": "", "effort": "", "preset": "", "prompt": "", "title": "", "open": False})]
...
def test_context_new_wait_polls_show_until_settled_and_prints_last_text(recorder, fake_clock, capsys):
    ...
    assert recorder.calls == [("context.new", {"model": "", "effort": "", "preset": "", "prompt": "x", "title": "", "open": False}),
...
def test_story_create_and_author_verbs_inside_a_character(recorder, monkeypatch):
    ...
    assert recorder.calls == [
        ("story.create", {"character": "chr1", "title": "t", "description": "", "start": True,
                          "model": "claude-sonnet-5", "effort": "", "preset": ""}),
