...
def main(argv=None):
    ...
    nw.add_argument("--model", default=None, help="a model id, or \"\" for the CLI's own default; omit for the position's (see `zharn cast options`)")
    nw.add_argument("--effort", default=None, help="low|medium|high|xhigh|max, or \"\" for the provider's own; omit for the position's")
    nw.add_argument("--preset", default=None, help="which skills it wakes up with; omit for the position's")
    ...
    for x in (c, s):
        x.add_argument("--model", default=None, help="a model id, or \"\" for the CLI's own default; omit for the position's (see `zharn cast options`)")
        x.add_argument("--effort", default=None, help="low|medium|high|xhigh|max, or \"\" for the provider's own; omit for the position's")
        x.add_argument("--preset", default=None, help="which skills it wakes up with; omit for the position's")
    ...
    cl.add_argument("--model", default=None, help="a model id, or \"\" for the CLI's own default; omit for the position's (see `zharn cast options`)")
    cl.add_argument("--effort", default=None, help="low|medium|high|xhigh|max, or \"\" for the provider's own; omit for the position's")
    cl.add_argument("--preset", default=None, help="which skills it wakes up with; omit for the position's")
    ...
    rcst.add_argument("--model", default=None, help="a model id, or \"\" for the CLI's own default; omit for the position's (see `zharn cast options`)")
    rcst.add_argument("--effort", default=None, help="low|medium|high|xhigh|max, or \"\" for the provider's own; omit for the position's")
    rcst.add_argument("--preset", default=None, help="which skills it wakes up with; omit for the position's")
