...
class ContextStore(QObject):
    ...
    def create(self, position: str, *, model: str = "", effort: str = "", preset: str = "",
    ...
    def fork(self, source_id: str, *, position: str, model: str = "", effort: str = "", preset: str = "",
    ...
    @intent
    def newBare(self, position: str = "", model: str = "", effort: str = "", preset: str = "") -> str:
