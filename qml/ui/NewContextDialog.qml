...
Popup {
    ...
    onOpened: picks.seedFromPosition()
    contentItem: ColumnLayout {
        ...
        Text {
            ...
            text: "A bare context: no story, no obligations, and the skills its preset gives it. The picks start on what a bare context is normally opened with."
        }
        CastPicks { id: picks; prefix: "bare"; position: app.casting.barePosition; Layout.fillWidth: true }
        RowLayout {
